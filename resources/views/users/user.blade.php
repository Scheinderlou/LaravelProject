...
<body class="bg-[#D9D9D9]">
    <div class="flex w-screen m-0">
        <div class="container mx-auto my-6 p-6 bg-[#008080] rounded-lg shadow-lg">
            <div class="text-lg font-bold">Payroll System</div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border-none px-4 py-2">
                                <span
                                    class="inline-block px-2 py-1 text-xs font-bold text-green-200 bg-green-800 rounded">
                                    Paid
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td class="border-none px-4 py-2">February 2025</td>
                            <td class="border-none px-4 py-2">$1,650</td>
                            <td class="border-none px-4 py-2">$250</td>
                            <td class="border-none px-4 py-2">$400</td>
                            <td class="border-none px-4 py-2">
                                <span
                                    class="inline-block px-2 py-1 text-xs font-bold text-green-200 bg-red-800 rounded">
                                    Unpaid
                                </span>
                            </td>
                        </tr>
                ...
                <div class="relative rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form action="#" method="POST" class="p-4 md:p-5">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="email" id="employee_email" name="employee_email" value="jezekiel@email.com"
                                class="bg-gray-400 text-black block w-full px-4 py-2 mt-1 rounded" required>
                        </div>
                        <div class="mb-5">
                ...
                <form action="#" method="POST" class="p-4 md:p-5">
                    <div class="flex gap-6">
                        ...
                        <div class="w-1/2">
                            ...
                            <div class="mb-4">
                                <label for="end_date" class="block text-sm font-medium">Pay Period End Date</label>
